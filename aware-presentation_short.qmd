...
waves <- data.frame(
  ...
  timing = c("May – Jun","Jun – Jul","Jul – Aug","Aug – Sep","Sep – Oct"),
  desc  = c("Baseline","No-treatment\ncheck","Video +\nReflection task",
            "Outcomes\n(incl. behavioral)","Decay"),
  note  = c("Polarization\nbaseline\nN ≈ 5,000",
            "Does polarization\nor priorities shift\nwithout treatment?",
            "Randomized\nby partisan\nblock",
            "Primary\nbehavioral\noutcome",
...
ggplot(waves) +
  ...
  geom_text(aes(x=wave, y=0.28, label=desc), color="white", size=2.5) +
...
## Expected Results {background-color="#ffffff"}

![](fig_expectations.gif){fig-align="center" width="94%"}

::: aside
Simulated data for illustration · Concerns about polarization remain stable across all waves for both groups · Behavioral engagement rises for the treatment group from Wave 3 (first video) and consolidates at Wave 4 · Wave 5 tests persistence of effects
:::
