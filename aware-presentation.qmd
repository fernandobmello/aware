...
```{r waves, fig.height=2.8, fig.width=12}
library(ggplot2)
waves <- data.frame(
  wave  = 1:6,
  label = c("Wave 1","Wave 2","Wave 3","Wave 4","Wave 5","Wave 6"),
...
ggplot(waves) +
  ...
  geom_text(aes(x=wave, y=0.72, label=label), color="white",
            fontface="bold", size=3.5) +
  geom_text(aes(x=wave, y=0.33, label=desc), color="white", size=2.5) +
  geom_text(aes(x=wave, y=-0.2, label=note), color="#555555",
            size=2.3, lineheight=0.9) +
  geom_segment(data=data.frame(x=1:5+0.43, xend=1:5+0.57),
